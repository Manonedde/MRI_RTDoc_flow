...
column_dict_name = {
        "lesion_load_per_point": [["sid", "roi", "metrics", "section",
                                  ...
                                  ["sid", "roi", "metrics", "section",
                                   "lesion_label"]],
        "lesion_load": [["sid", "roi", "metrics", "lesion_label", "value"],
        ...
        "volume": [["sid", "roi", "metrics", "value"],
                   ['sid', 'roi', 'metrics']],
        "volume_per_label": [["sid", "roi", "metrics", "section", "value"],
                             ["sid", "roi", "metrics", "section"]],
        "lesion_load_per_point_nolist": [["sid", "roi", "metrics", "section",
                                        "value"],
                                         ["sid", "roi", "metrics", "section"]],
...
measure_dict = {
        ...
        "ad_fw_corrected": "AD-FWcorrected", 'fa_fw_corrected':'FA-FWcorrected', 
        'md_fw_corrected':'MD-FWcorrected', 'rd_fw_corrected':'RD-FWcorrected',
...
list_metrics = [
    ...
    ['FA-FWcorrected', 'MD-FWcorrected', 'RD-FWcorrected',
     ...
     'ad_fw_corrected', 'fa_fw_corrected', 'md_fw_corrected', 'rd_fw_corrected'],
    ['FW', 'fw'],
...
replace_dict = {'roi': ['_labels', '_v10_labels', '_v10'],
                'metrics': ['_metric', 'min_', 'mean_', 'max_',
                            'std_', '_volume', '_count'],
                'stats': ['_length', 'lesion_total_', 'lesion_',
                          'streamline_']}
...
replace_bundles_dict = {
        "AC_": "", "AC": "", "AF_L_": "", "AF_L": "", "AF_R_": "", "AF_R": "",
        "CC_1_": "", "CC_2a_": "", "CC_2b_": "", "CC_3_": "", "CC_4_": "",
        "CC_5_": "", "CC_6_": "", "CC_7_": "", "CC_Te_": "", "CC_Fr_1_": "",
        "CC_Fr_2_": "", "CC_Oc_": "", "CC_Pa_": "", "CC_Pr_Po_": "",
        "CC_Te_": "", "CC_1": "", "CC_2a": "", "CC_2b": "", "CC_3": "",
        "CC_4": "", "CC_5": "", "CC_6": "", "CC_7": "", "CC_Te": "",
        "CC_Fr_1": "", "CC_Fr_2": "", "CC_Oc": "", "CC_Pa": "", "CC_Pr_Po": "",
        "CC_Te": "", "CG_L_": "", "CG_L": "", "CG_R_": "", "CG_R": "",
...
measure_by_method_dict = {
        'FODF': ['NuFO', 'nufo', 'AFD_total', 'afd_total', 'AFD_fixel',
                 'afd_along', 'Radial_fODF', 'radfODF', 'afd', 'AFD',
                 'AFD_sum', 'afd_sum'],
        ...
        'MTI': ['MTR', 'MTsat', 'ihMTR', 'ihMTdR1sat', 'ihMTsat', 'mtr',
                'mtsat', 'ihmtr', 'ihmtsat', 'ihmtdR1sat'],
        'HARDI': ['APower', 'apower', 'GFA', 'gfa'],
        'QSM': ['RDF', 'rdf', 'QSM', 'qsm'],
        'Streamlines': ['Volume', 'Count', 'volume', 'streamline_count',
                        'Length', 'min_length', 'length'],
        'Lesion': ['lesion_volume', "Lesion_volume", 'lesion_total_volume',
                   'Lesion_total_volume', 'lesion_count', 'Lesion_count']}
