...
measure_dict = {"radfODF" : 'Radial_fODF', "fa" : 'FA', "md": 'MD', "rd" : 'RD',
                ...
                "volume" : 'Volume', "streamline_count": 'Count',
                "length" : 'Lenght', 'lesion_volume':"Lesion_volume",
...
list_metrics = [['NuFO','nufo','AFD_total','afd_total','AFD_fixel','afd_along',
                ...
                ['RDF','rdf','QSM','qsm'],
                ['Volume','Count','volume','streamline_count',
...
replace_dict = {'roi':'_labels', 'metrics':['_metric','min_'],
                'stats':'_length'}
